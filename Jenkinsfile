pipeline {
    ...
    stages {
        ...
        stage ('Deploy Frontend') {
            steps {
                dir('frontend') {
                    git credentialsId: 'loginGitHub', url: 'https://github.com/marcelodebittencourt/tasks-frontend'
    ...
    post {
        ...
        unsuccessful {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'tchelopoa+jenkins2@gmail.com'
        }
        fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER is fine!!!', to: 'tchelopoa+jenkins2@gmail.com'
        }        
    }
}
